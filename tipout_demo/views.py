...
from tipout_demo.models import Tip, EnterTipsForm, Paycheck, EditPaycheckForm, Expense, DemoEmployee, Expenditure, EnterPaycheckForm, EnterExpenditureForm, EnterExpenseForm, EditExpenseForm, NewUserSetupForm
...
def signup(request, template_name):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            DemoEmployee.objects.create(user=new_user)
