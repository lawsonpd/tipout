...
urlpatterns = [
    ...
    path('edit-expense/<str:expense>/', expenses.edit_expense, name='edit-expense'),
    path('delete-expense/<str:expense>/', expenses.delete_expense, name='delete-expense'),
    ...
    path('expenditures/archive/<int:year>/<int:month>/<int:day>/<str:exp>', expenditures.expenditure_detail, name='expenditure-detail'),
    ...
    # ),
    path('launch-demo/', demo_subscription.launch_demo, name='launch-demo'),
    path('signup/',
        subscription.signup,
